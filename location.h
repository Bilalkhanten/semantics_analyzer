 ...
 * used to record the lexical position of a token or symbol.  This
 * file establishes the cmoon definition for the yyltype structure,
 * the global variable yylloc, and a utility function to join
 * locations you might find handy at times.
 */
